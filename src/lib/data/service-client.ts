...
export const serviceClient: Category = {
  slug: "meilleure-ia-service-client",
  title: "Meilleure IA pour le service client en 2025",
  shortTitle: "IA Service Client",
  ...
  tools: [
    {
      ...
      bestFor:
        "Entreprises SaaS et e-commerce ayant un volume important de demandes clients et utilisant deja Intercom.",
      rating: 4.7,
    ...
    },
    {
      ...
      bestFor:
        "Moyennes et grandes entreprises recherchant une plateforme de service client complete avec des capacites IA integrees.",
      rating: 4.5,
    ...
    },
    {
      ...
      bestFor:
        "PME et startups cherchant une solution IA pour le service client avec un bon rapport qualite-prix.",
      rating: 4.3,
    ...
    },
    {
      ...
      bestFor:
        "Petites entreprises et e-commerces recherchant un chatbot IA simple a deployer avec un budget limite.",
      rating: 4.2,
    ...
    },
    {
      ...
      bestFor:
        "Boutiques en ligne sur Shopify, Magento ou BigCommerce cherchant a automatiser le support client lie aux commandes.",
      rating: 4.4,
  ...
  selectionCriteria: [
    {
      title: "Volume et complexite des demandes",
      description:
    ...
    {
      title: "Integrations avec vos outils existants",
      description:
    ...
    {
      title: "Budget et modele de tarification",
      description:
    ...
    {
      title: "Qualite de la resolution automatique",
      description:
