...
export default function ComparisonTable({ tools }: ComparisonTableProps) {
  return (
    <div className="overflow-x-auto mb-10">
      <table className="w-full border-collapse bg-white rounded-xl border border-gray-100 text-sm">
        <thead>
          <tr className="bg-linear-to-r from-accent to-accent-dark text-white">
          ...
          {tools.map((tool, index) => (
            ...
            >
              ...
              <td className="p-3 text-center">
                <span className="inline-flex items-center gap-1 bg-warm/10 text-warm font-bold px-2 py-1 rounded text-xs">
